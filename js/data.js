...
const RESEPI = [
  ...
  },
  {
    ...
    kategori: 'nasi-mi',
    img: 'images/resepi/ayam-goreng-kunyit.webp',
    penulis: 'Resepi Kampung',
    tarikh: '2026-09-03',
    kesukaran: 'Mudah',
  ...
  },
  {
    ...
    kategori: 'nasi-mi',
    img: 'images/resepi/nasi-kari-kambing.webp',
    penulis: 'Resepi Kampung',
    tarikh: '2026-09-03',
    kesukaran: 'Mudah',
    tag: ['nasi kari', 'kambing', 'air asam kerisik'],
    bahan: [
      '— Nasi Kari Kambing —',
      '1–2 sudu besar minyak sapi atau butter',
      '3 ulas bawang putih',
      '½ biji bawang besar',
      'Halia',
      '3 sekawan',
    ...
    langkah: [
      'Untuk langkah penyediaan lengkap, rujuk video asal di TikTok.'
    ],
